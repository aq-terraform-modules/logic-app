    ...
    "resources": [
        {
            ...
            "properties": {
                ...
                "api": {
                    "id": "[concat('/subscriptions/d0767e87-e2a6-4477-a762-768ce1367057/providers/Microsoft.Web/locations/', parameters('location'), '/managedApis/', parameters('connections_sql_name'))]"
                },
                "parameterValues": {
